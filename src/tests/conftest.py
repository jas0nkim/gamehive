...
def insert_test_data():
    ...
    with sqlalchemy.create_engine(TestingConfig.SQLALCHEMY_DATABASE_URI).connect() as conn:
        ...
        insert_data = [
            ...
            f"""INSERT INTO players(id, nickname, email, skill_point, guild_id) VALUES('{uu_ids["oplayer11"]}', 'oplayer11', 'oplayer11@mail.com', 650, '{uu_ids["oguild05"]}')""",
            f"""INSERT INTO players(id, nickname, email, skill_point, guild_id) VALUES('{uu_ids["oplayer12"]}', 'oplayer12', 'oplayer12@mail.com', 100, '{uu_ids["oguild05"]}')""",
            f"""INSERT INTO players(id, nickname, email, skill_point, guild_id) VALUES('{uu_ids["oplayer13"]}', 'oplayer13', 'oplayer13@mail.com', 300, '{uu_ids["oguild05"]}')""",
            f"""INSERT INTO players(id, nickname, email, skill_point, guild_id) VALUES('{uu_ids["oplayer14"]}', 'oplayer14', 'oplayer14@mail.com', 120, '{uu_ids["oguild05"]}')""",
            f"""INSERT INTO players(id, nickname, email, skill_point, guild_id) VALUES('{uu_ids["oplayer15"]}', 'oplayer15', 'oplayer15@mail.com', 340, '{uu_ids["oguild05"]}')""",
            ...
            f"""INSERT INTO player_items(player_id, item_id) VALUES('{uu_ids["oplayer11"]}', '{uu_ids["oitem07"]}')""",
            f"""INSERT INTO player_items(player_id, item_id) VALUES('{uu_ids["oplayer11"]}', '{uu_ids["oitem08"]}')""",
            f"""INSERT INTO player_items(player_id, item_id) VALUES('{uu_ids["oplayer11"]}', '{uu_ids["oitem09"]}')""",
            f"""INSERT INTO player_items(player_id, item_id) VALUES('{uu_ids["oplayer12"]}', '{uu_ids["oitem07"]}')""",
            f"""INSERT INTO player_items(player_id, item_id) VALUES('{uu_ids["oplayer13"]}', '{uu_ids["oitem07"]}')""",
            f"""INSERT INTO player_items(player_id, item_id) VALUES('{uu_ids["oplayer13"]}', '{uu_ids["oitem08"]}')""",
            f"""INSERT INTO player_items(player_id, item_id) VALUES('{uu_ids["oplayer14"]}', '{uu_ids["oitem10"]}')""",
        ]
